...
export const BUILTIN_TEMPLATES: Seed[] = [
  ...
  },
  {
    ...
    format: 'soap',
    sections: [
      { key: 'subjective', label: 'Subjective', promptHint: 'Patient report', required: true },
      {
        key: 'objective',
        label: 'Objective',
        promptHint: 'Measurements & interventions',
        required: true,
      },
      { key: 'assessment', label: 'Assessment', promptHint: 'Clinical reasoning', required: true },
      { key: 'plan', label: 'Plan', promptHint: 'Next steps', required: true },
    ],
